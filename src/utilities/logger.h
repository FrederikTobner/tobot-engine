...
class Logger {
  public:
    ...
    template <typename... Args> static void Trace(char const * message, Args... args) {
        get_Instance().log(TRACE_PRIORITY, message, args...);
    }

    template <typename... Args> static void Trace(std::string message, Args... args) {
        Trace(message.c_str(), args...);
    }

    template <typename... Args> static void Debug(char const * message, Args... args) {
        get_Instance().log(DEBUG_PRIORITY, message, args...);
    }

    template <typename... Args> static void Debug(std::string message, Args... args) {
        Debug(message.c_str(), args...);
    }

    template <typename... Args> static void Info(char const * message, Args... args) {
        get_Instance().log(INFO_PRIORITY, message, args...);
    }

    template <typename... Args> static void Info(std::string message, Args... args) {
        Info(message.c_str(), args...);
    }

    template <typename... Args> static void Warn(char const * message, Args... args) {
        get_Instance().log(WARN_PRIORITY, message, args...);
    }

    template <typename... Args> static void Warn(std::string message, Args... args) {
        Warn(message.c_str(), args...);
    }

    template <typename... Args> static void Error(char const * message, Args... args) {
        get_Instance().log(ERROR_PRIORITY, message, args...);
    }

    template <typename... Args> static void Error(std::string message, Args... args) {
        Error(message.c_str(), args...);
    }

    template <typename... Args> static void Critical(char const * message, Args... args) {
        get_Instance().log(CRITICAL_PRIORITY, message, args...);
    }

    template <typename... Args> static void Critical(std::string message, Args... args) {
  ...
  private:
    ...
    template <typename... Args> void log(LogPriority message_priority, char const * message, Args... args) {
