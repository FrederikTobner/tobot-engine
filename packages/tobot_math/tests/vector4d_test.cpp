...
TEST(Vector4D, CanBeCreatedWithList) {
    Tobot::Math::Vector4D<> vector = {1, 2, 3, 4};
}
 ...
 */
TEST(Vector4D, Copy) {
    Tobot::Math::Vector4D<> firstVector(5, 3, 6, 1);
    Tobot::Math::Vector4D<> secondVector(firstVector);
...
TEST(Vector4D, Addition) {
    Tobot::Math::Vector4D<> vector1(5, 3, 6, 1);
    Tobot::Math::Vector4D<> vector2(4, 2, -2, -1);

    Tobot::Math::Vector4D<> result = vector1 + vector2;
...
TEST(Vector4D, Subtraction) {
    Tobot::Math::Vector4D<> vector1(5, 4, 6, 1);
    Tobot::Math::Vector4D<> vector2(4, 2, -2, -1);
...
TEST(Vector4D, Multiplication) {
    Tobot::Math::Vector4D<> vector1(5, 4, 1, 2);

    Tobot::Math::Vector4D<> result = vector1 * 3;
...
TEST(Vector4D, Division) {
    Tobot::Math::Vector4D<> vector1(9, 6, 3, 12);
...
TEST(Vector4D, Equality) {
    Tobot::Math::Vector4D<> vector1(9, 6, 3, 12);
    Tobot::Math::Vector4D<> vector2(9, 6, 3, 12);
    Tobot::Math::Vector4D<> vector3(9, 6, 3, 13);
...
TEST(Vector4D, Magnitude) {
    Tobot::Math::Vector4D<> leVector(4, 3, 0, 0);
...
TEST(Vector4D, Normalize) {
    Tobot::Math::Vector4D<> leVector(4.0, 3.0, 2.5, 1.5);
    leVector.Normalize();
...
TEST(Vector4D, DotProduct) {
    Tobot::Math::Vector4D<> vector1(4, 3, 2, 1);
    Tobot::Math::Vector4D<> vector2(1, 2, 3, 4);
